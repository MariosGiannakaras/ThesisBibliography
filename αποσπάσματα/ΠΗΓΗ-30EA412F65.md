## ΠΗΓΗ-30EA412F65 — A Survey of Human-in-the-Loop Reinforcement Learning for Critical Systems

- **Προτεραιότητα:** P1-core
- **Θέματα:** nonstationarity, governance-ethics
- **Πηγή:** https://cognizancejournal.com/vol6issue4/V6I402.pdf
- **Αρχείο:** `sources/markdown/ΠΗΓΗ-30EA412F65__a-survey-of-human-in-the-loop-reinforcement-learning-for-critical-system.md`
