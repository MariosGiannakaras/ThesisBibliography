...
Failure και recovery times μπορεί να εξαρτώνται από smoothing, window και threshold. Πρέπει να προκαθοριστούν πριν την ανάλυση των αποτελεσμάτων και να συνοδεύονται από raw curves.
...
Να αναφέρονται primitive metrics ως primary και οποιοδήποτε resilience index ως secondary, με ablation ή sensitivity του aggregation.
...
Να σχεδιαστεί perturbation matrix με low, medium και high severity και single ή repeated changes, με κοινά seeds και confidence intervals.
