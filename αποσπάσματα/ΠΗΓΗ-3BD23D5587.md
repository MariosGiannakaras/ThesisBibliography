## ΠΗΓΗ-3BD23D5587 — This is a pre-print of the following paper:

- **Προτεραιότητα:** P2-supporting
- **Θέματα:** resilience-recovery
- **Πηγή:** https://arxiv.org/abs/2102.00528
- **Αρχείο:** `sources/markdown/ΠΗΓΗ-3BD23D5587__this-is-a-pre-print-of-the-following-paper.md`
