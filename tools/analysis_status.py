...
from decision_status import SELECTED_ROLES, excerpt_is_verified, infer_decision, normalize
...
REPORT_CSV = ROOT / "catalog" / "analysis-status.csv"
REPORT_MD = ROOT / "catalog" / "analysis-status.md"
...
def main() -> int:
    ...
    lines = [
        ...
        "",
        "> Η αναφορά παράγεται από το τρέχον `catalog/sources.csv`, τα canonical `analyses/` "
        "και τα verified `evidence/`. Παλιές generated rows δεν χρησιμοποιούνται ως πηγή αλήθειας.",
        "",
