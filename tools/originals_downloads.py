...
from sources_common import ARXIV_RE, OPENREVIEW_RE, URL_RE, explicit_source_sample, identities
from originals_common import DownloadResult, ORIGINALS, url_is_direct_pdf
