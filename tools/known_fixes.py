...
PENDING = ROOT / "new-originals" / "εκκρεμή"
FIELDS = [
...
- **Πρωτότυπο:** `originals/SRC-C7E22C59DE.pdf`
...
- **Πρωτότυπο αγγλικής έκδοσης:** `originals/SRC-13CFB90F59.pdf`
- **Εναλλακτική ιταλική έκδοση:** `originals/SRC-13CFB90F59__alternative-6799C781D0.pdf`
