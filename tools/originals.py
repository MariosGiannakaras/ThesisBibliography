...
from sources_common import SOURCE_ID_RE, source_text
from originals_files import (
    import_uploaded,
    match_uploaded,
...
from originals_downloads import candidate_urls, download_pdf, looks_like_pdf
