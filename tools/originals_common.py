...
from sources_common import ARXIV_RE, DOI_RE, OPENREVIEW_RE, normalized, normalized_words

ROOT = Path(__file__).resolve().parents[1]
SOURCES = ROOT / "sources"
ORIGINALS = ROOT / "originals"
UNMATCHED = ORIGINALS / "unidentified"
INCOMING = ROOT / "new-originals"
CATALOG = ROOT / "catalog" / "sources.csv"
REPORT_CSV = ROOT / "catalog" / "originals.csv"
REPORT_MD = ROOT / "catalog" / "originals.md"
PENDING_REPORT = ROOT / "catalog" / "pending-originals.md"
CATALOG_FIELDS = [
