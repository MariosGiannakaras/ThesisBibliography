...
Το `πακέτο-διπλωματικής/SOURCE_COMMIT` παραμένει stale στο `9c3ccdc7801d3a12b29576c4230eba01fa982ad4`. Η canonical επιστημονική κατάσταση βρίσκεται στα `αναλύσεις/`, `αποσπάσματα/` και `κατάλογος/επιλογή-διπλωματικής.csv`.