...
Λαμβάνει μόνο το παραγόμενο `πακέτο-διπλωματικής/`, δηλαδή:
...
3. Εκτελεί το `εργαλεία/εξαγωγή-διπλωματικής.py` ή αντιγράφει το ήδη παραγόμενο πακέτο.
...
- `πρωτότυπα/` και Git LFS αντικείμενα,
- `νέες-πηγές/` και `νέα-πρωτότυπα/`,
