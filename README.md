...
Η συνολική κατάσταση εμφανίζεται στα `κατάλογος/πρωτότυπα.md` και `κατάλογος/εκκρεμή-πρωτότυπα.md`.
...
│   └── μη-ταυτοποιημένα/          # μόνιμη αρχειοθήκη PDF χωρίς ασφαλή αντιστοίχιση
